...
export default class Map18 extends KiosksTemplate {
  availableKiosks = 6;
  ...
  fields = [false, false, false, false, false, false, false, false, false, false, false, false];

  initGraph():void {
    for (let i = 0; i < this.nrOfFields; i += 1) {
      this.map.addVertex(i);
    }
    // Map 8 - 12 vertices, v.o.l.n.u.r., min = 4
...
.map-container {
  ...
  background-image: url('maps/map18.png');
